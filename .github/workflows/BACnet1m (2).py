...
from tkinter import ttk,Tk,StringVar,Entry,IntVar,Button,END,RAISED
...
def bacnetiam(bvlc_length,npdu_control,npdu_dst_mac,npdu_dst_mac_length,npdu_hop_count,apdu_objectid,apdu_objinst,max_apdu,segment_support,app_vendor_id):
    bvlc_type = 129
    bvlc_function = 10
...
def bacnetunconfcov(bvlc_length,npdu_control,subscriber_processid,apdu_deviceid,apdu_deviceinst,apdu_objectid,apdu_objectinst,propid1,propinst1,propinst2,propid2,propinst3,propinst4):
    ...
    bacnetunconfcov =  struct.pack("!BBHBBBBBBBHHBHHBBBBBBBHHBBBBBHHBB", 
        bvlc_type, 
        bvlc_function, 
        bvlc_length, 
        npdu_version,
...
def bacnetalarm(bvlc_length,npdu_control,max_apdu_size,invoke_id):
...
def bacnetcov(bvlc_length,npdu_control,max_apdu_size,invoke_id,subscriber_processid,apdu_objectidentifier,apdu_objectinstance,issue_notification,context_tag3,life_time):
...
def bacnetaddlist(bvlc_length,npdu_control,max_apdu_size,invoke_id,apdu_objectidentifier,apdu_objectinstance,property_id,prop_value1,prop_value2):
    ...
    bacnetaddlist =  struct.pack("!BBHBBBBBBBHHBBBBHHB", 
        bvlc_type, 
        bvlc_function, 
        bvlc_length, 
        npdu_version,
...
def bacnetcreate(bvlc_length,npdu_control,max_apdu_size,invoke_id,apdu_objectidentifier,apdu_objectinstance,propertyidentifier):
...
def bacnetread(bvlc_length,npdu_control,max_apdu_size,invoke_id,apdu_objectidentifier,apdu_objectinstance,apdu_propertyidentifier):
    ...
    bacnetread =  struct.pack("!BBHBBBBBBBHHBB", 
        bvlc_type, 
        bvlc_function, 
        bvlc_length, 
        npdu_version,
...
def bacnetwritem(bvlc_length,max_apdu_size,invoke_id,apdu_objectidentifier1,apdu_objectinstance1,property_id1,data1,data2,apdu_objectidentifier2,apdu_objectinstance2,property_id2,data3,data4):
...
def bacnetrd(bvlc_length,max_apdu_size,invoke_id,device_state,passw):
    ...
    bacnetrd =  struct.pack("!BBHBBBBBBBBBBB", 
        bvlc_type, 
        bvlc_function, 
        bvlc_length, 
        npdu_version,
...
def bacnet_ack(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_c,max_apdu,invokeid,processid,m,objinst,event_ack,seqn1,acksrc,stamp in product(range(30,5238),range(0,80),range(0,256),range(0,256),range(0,256),range(len(obj)),range(0,65536),range(0,256),range(0,256),range(0,256),range(0,256)):
...
def bacnet_iam(ip_address,port_no,timedl):
    ...
    for bvlen,npdu_control,npdu_dst_mac,npdu_dst_mac_length,npdu_hopcount,objinst,max_apdu,segment,vendorid in product(range(24,65536),range(32,80),range(0,65536),range(0,256),range(0,256),range(0,65536),range(0,256),range(0,5),range(0,256)):
...
def bacnet_unconfcov(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,processid,deviceinst,m,objinst,propid1,propinst1,propinst2,propid2,propinst3,propinst4 in product(range(42,5238),range(0,80),range(0,256),range(0,65536),range(len(obj)),range(0,65536),range(0,256),range(0,65536),range(0,65536),range(0,256),range(0,65536),range(0,65536)):
...
def bacnet_unconfevent(ip_address,port_no,timedl,obj):
  ...
  for bvlen,npdu_c,processid,deviceinst,m,objinst,sqno,notcls,etype,m1,m2,m3,nottype,ackreq,fs,ts,bv,sf in product(range(42,5238),range(0,80),range(0,256),range(0,65536),range(len(obj)),range(0,256),range(0,256),range(0,256),range(0,256),range(0,65536),range(0,65536),range(0,65536),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256)):
...
def bacnet_timesyn(ip_address,port_no,timedl):
    ...
    time_sec=random.randrange(0,256)
    time_msecs=random.randrange(0,256)
    count=1
    
    timesyn=bacnettimesyn(bvlen,npdu_c,date1,date_month,date_day,date_week,time1,time_min,time_sec,time_msecs)
  
    for bvlen,npdu_control,date1,date_month,date_day,date_week,time_min,time_sec,time_msecs in product(range(18,5238),range(32,80),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256)):
        if ((timesyn[0]==129) and (timesyn[1]==10) and (timesyn[6]==16) and (timesyn[7]==6) and (timesyn[8]==164) and (timesyn[13]==180) and running==0):
            s.sendto(bacnettimesyn(bvlen,npdu_c,date1,date_month,date_day,date_week,time1,time_min,time_sec,time_msecs),(ip_address,port_no))
            time.sleep(0.1)
...
def bacnet_concov(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,processid,deviceinst,m,objinst,propid1,propinst1,propinst2,propid2,propinst3,propinst4 in product(range(44,5238),range(0,80),range(0,256),range(0,4000,64),range(len(obj)),range(0,65536),range(0,256),range(0,65536),range(0,65536),range(0,256),range(0,65536),range(0,65536)):
...
def bacnet_confevent(ip_address,port_no,timedl,obj):
  ...
  for bvlen,npdu_c,processid,deviceid,deviceinst,m,objinst,sqno,notcls,pr,etype,m1,m2,m3,nottype,ackreq,fs,ts,bv,sf in product(range(59,5238),range(0,80),range(0,256),range(0,4000,64),range(0,65536),range(len(obj)),range(0,65536),range(0,256),range(0,256),range(0,256),range(0,256),range(0,65536),range(0,65536),range(0,65536),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256)):
...
def bacnet_alarm(ip_address,port_no,timedl):
    ...
    for bvlen,npdu_cntrl,max_apdusz,invoke_id in product(range(10,5238),range(0,80),range(0,256),range(0,256)):
        if ((bac_alarm[0]==129) and (bac_alarm[1]==10) and (bac_alarm[4]==1) and (bac_alarm[6]==0) and (bac_alarm[9]==3) and running==0):
            ...
            table_1.insert('', index='end',values=("Alarm_Summary %d"%(count),"passed"))
            count+=1
            tab3.update()
            tab3.after(timedl)
        elif(running==2):
            table_1.insert('', index='end',values=("Alarm_Summary %d"%(count),"failed"))
            count+=1
        else:
            table_1.insert('', index='end',values=("aborted"))
            break
...
def bacnet_enroll(ip_address,port_no,timedl):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,process_id,rece_objinst,stateft,stateft,typeft in product(range(27,65536),range(0,80),range(0,256),range(0,256),range(6400,6656),range(0,4000,64),range(0,256),range(0,5),range(0,256)):
        if ((enr[0]==129) and (enr[1]==10) and (enr[4]==1) and (enr[6]==0) and (enr[9]==4) and (enr[12]==30) and (enr[13]==14) and (enr[14]==12) and (enr[19]==15) and (enr[22]==31) and (enr[25]==57) and running==0):
            ...
            table_1.insert('', index='end',values=("Enrollment_Summary %d"%(count),"passed"))
            count+=1
            tab3.after(timedl)
            tab3.update()
            count+=1
        elif(running==2):
            table_1.insert('', index='end',values=("Enrollment_Summary %d"%(count),"failed"))
            count+=1
        else:
            table_1.insert('', index='end',values=("aborted"))
            break
...
def bacnet_cov(ip_address,port_no,timedl,obj):
    ...
    max_apdu=random.randrange(0,256)
    invoke_id=random.randrange(0,256)
    subscriber_processid=random.randrange(0,256)
    objectid1=random.randrange(0,4000,64)
    objinst=random.randrange(0,65536)
    issue_notification=random.randrange(0,256)
    context3=random.choice([57,58])
    lifetime=random.randrange(0,65536)
    count=1
    
    cov=bacnetcov(bvlen,npdu_control,max_apdu,invoke_id,subscriber_processid,objectid1,objinst,issue_notification,context3,lifetime)
    
    for bvlen,npdu_control,max_apdu,invoke_id,subscriber_processid,m,objinst,issue_notification,lifetime in product(range(22,5238),range(0,80),range(0,256),range(0,256),range(0,256),range(len(obj)),range(0,256),range(0,256),range(0,65536)):                                       
        if ((cov[0]==129) and (cov[1]==10) and (cov[4]==1) and (cov[6]==0) and (cov[9]==5) and (cov[10]==9) and (cov[12]==28) and (cov[17]==41) and (cov[19]==57 or cov[19]==58) and running==0):
            s.sendto(bacnetcov(bvlen,npdu_control,max_apdu,invoke_id,subscriber_processid,obj[m],objinst,issue_notification,context3,lifetime),(ip_address,port_no))
...
def bacnet_readfile(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objinst,startec,reqcount in product(range(21,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,65536),range(0,256),range(0,256)):
...
def bacnet_writefile(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objinst,startec,reqcount in product(range(21,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,256),range(0,256),range(0,256)):
...
def bacnet_addlist(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objinst,propid,prop1,prop2 in product(range(24,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,65536),range(0,256),range(16525,65536,128),range(0,65536)):
...
def bacnet_removelist(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objinst,propid,prop1,prop2 in product(range(16,65536),range(0,256),range(0,256),range(0,256),range(len(obj)),range(0,65536),range(0,256),range(16526,65536,128),range(0,65536)):
...
def bacnet_create(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objectinst,propid in product(range(16,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,256),range(0,256)):
...
def bacnet_delete(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objectinst in product(range(16,65536),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,256)):
...
def bacnet_readrange(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_di,m,objinst,propid,ref_in,ref_count in product(range(23,65536),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,65536),range(0,256),range(0,256),range(0,256)):
...
def bacnet_read(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objectinst,propid1 in product(range(17,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,256),range(0,256)):
...
def bacnet_readmultiple(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_control,max_apdu,invoke_id,m,objectinst,propid1,propid2,propid3 in product(range(23,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,256),range(0,256),range(0,256),range(0,256)):
...
def bacnet_write(ip_address,port_no,timedl,obj):
    ...
    for bvlen,max_apdu,invoke_id,m,objinst,propid,data1,data2 in product(range(24,65536),range(0,256),range(0,256),range(len(obj)),range(0,256),range(0,256),range(0,65536),range(0,65536)):
...
def bacnet_writemultiple(ip_address,port_no,timedl,obj):
    ...
    writep=bacnetwritem(bvlen,max_apdu,invoke_id,objid1,objinst1,propid1,d1,d2,objid2,objinst2,propid2,d3,d4)
   
    for bvlen,max_apdu,invoke_id,objid1,objinst1,propid1,d1,d2,m,objinst2,propid2,d3,d4 in product(range(16,65536),range(0,256),range(0,256),range(0,4000,64),range(0,256),range(0,256),range(0,65536),range(0,65536),range(len(obj)),range(0,256),range(0,256),range(0,65536),range(0,65536)): 
        if((writep[0]==129) and (writep[1]==10) and (writep[4]==1) and (writep[6]==0) and (writep[6]==0) and (writep[9]==16) and (writep[10]==12) and (writep[15]==30) and (writep[16]==9) and (writep[18]==46) and (writep[19]==68) and (writep[24]==47) and (writep[25]==31) and (writep[26]==12) and (writep[31]==30) and(writep[32]==9) and (writep[34]==46) and (writep[35]==68) and (writep[40]==47) and (writep[41]==31) and running==0):
            s.sendto(bacnetwritem(bvlen,max_apdu,invoke_id,obj[m],objinst1,propid1,d1,d2,obj[m],objinst2,propid2,d3,d4),(ip_address,port_no))
...
def bacnet_dcc(ip_address,port_no,timedl):
    ...
    for bvlen,max_apdu,invoke_id,time_dur,en_dis,passw in product(range(16,65536),range(0,256),range(0,256),range(0,256),range(0,256),range(0,256)):
...
def bacnet_rd(ip_address,port_no,timedl):
    ...
    for bvlen,max_apdu,invoke_id,device_st,passw in product(range(15,65536),range(0,256),range(0,256),range(0,256),range(0,256)):
...
def bacnet_eventinfo(ip_address,port_no,timedl,obj):
    ...
    for bvlen,npdu_cntrl,max_apdusz,invoke_id,m,objinst in product(range(15,5238),range(0,80),range(0,256),range(0,256),range(len(obj)),range(0,256)):
